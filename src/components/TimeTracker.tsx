...
const TimeTracker = () => {
  ...
  const [selectedItemId, setSelectedItemId] = useState<unknown>(null);
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <View style={styles.pickerContainer}>
                        <Picker
                          ...
                          onValueChange={itemValue => handleStartTime(itemValue, id)}>
                    ...
                    <View style={{ flex: 1 }}>
                      ...
                      <View style={styles.pickerContainer}>
                        <Picker
                          ...
                          onValueChange={itemValue => handleEndTime(itemValue, id)}>
                          <Picker.Item value="00" label="12:00 AM" />
                          <Picker.Item value="1" label="1:00 AM" />
                          <Picker.Item value="2" label="2:00 AM" />
                          <Picker.Item value="3" label="3:00 AM" />
